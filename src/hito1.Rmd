...
data <- read.delim("/Users/jhonc/Workspace/data-mining/data/iris-data/chile_data/all.csv", header = TRUE, sep = "|", quote = "\"",
...
prAmon <- t(read.csv("/Users/jhonc/Workspace/data-mining/r_sismos_chile/Datasets\ meteorológicos/cr2_prAmon_2018/cr2_prAmon_2018.txt"))
...
Código utilizado para extraer los datos:

```{r}
library(xlsx)
source("/Users/jhonc/Workspace/data-mining/r_sismos_chile/src/cargar_sismos_con_region.r")
source("/Users/jhonc/Workspace/data-mining/r_sismos_chile/src/cargar_etas.r")
...
El código de carga de los datos corresponde a
```{r}
