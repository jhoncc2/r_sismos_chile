...
Los sismos en Chile son fenómenos muy recurrentes. Aun son impredecibles.

Los sismos puden tener consecuencias de alto costo humano y economico, por ello es importante no solo intentar predecir su ocurrencia sino también evaluar el efecto que podrían provocar el sismo en otros ámbitos. 
...
Se indaga si eventos sismicos tiene relación con las enfermedades con eventos transmitidas por alimentos (ETA) como tambien .
...
![Relacion lluvia y sismos](img/sis_hist.png)
