...
```{r}
aggregate(Aumento ~ Region, mag5_3d, FUN=mean)
aggregate(Aumento ~ Region, mag5_7d, FUN=mean)
aggregate(Aumento ~ Region, mag5_14d, FUN=mean)
aggregate(Aumento ~ Region, mag5_30d, FUN=mean)
```
...
```{r}
aggregate(Aumento ~ Region, mag6_3d, FUN=mean)
